...
//Asegúrate de que WordPress no llame a este archivo directamente.
    ...
    <div class="cita">
       <!-- <h4>Cita #<?php //echo $cita->id; ?></h4> -->
        <table>
            ...
            <!-- Agrega aquí más filas si tienes más campos -->
        </tbody>
    </table>
</div>
<?php endforeach; ?>
...
<?php foreach ($informe->detalles->antecedentesMedicos as $antecedente): ?>
    <div class="antecedente">
        <!-- <h4>Antecedente #<?php //echo $antecedente->id; ?></h4> -->
        <table>
            <tbody>
                <tr>
                    <td>Otras Causas:</td>
...
=======
            <p>El paciente acepta que este informe medico es emitido por un medico colegiado y registrado en Venezuela</p>
        </div>
    </div>
</body>
</html>
...
// Obtén la ruta base de la carpeta de uploads de WordPress
$upload_dir = wp_upload_dir();
$baseDir = $upload_dir['basedir']; // Usar 'basedir' en lugar de 'path'
$carpetaDestino = $baseDir . '/midocdoc/reportes';
...
// Guarda el archivo si no existe
if (!file_exists($rutaPdf)) {
    file_put_contents($rutaPdf, $domPdf->output());
}
